package com.oguztasgin.MovieAppJava5.utility;
...
import com.oguztasgin.MovieAppJava5.service.GenreService;
import com.oguztasgin.MovieAppJava5.service.MovieService;
import com.oguztasgin.MovieAppJava5.service.UserService;
import com.oguztasgin.MovieAppJava5.utility.data.Sample;
...
//        createUser();
    ...
    public void createUser(){
        ...
        user4.setComments(List.of(
                ...
                MovieComment.builder().content("şahane").date(LocalDate.now().minusDays(12)).user(user4).movie(movieService.findbyId(105L)).build(),
